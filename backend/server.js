...
// مسارات الإعدادات (الجوال والإيميل)
...
app.put('/api/settings', async (req, res) => {
  ...
  const s = await sql`UPDATE settings SET phone=${phone}, email=${email} WHERE id=1 RETURNING *`;
  res.json(s[0]);
});
...
app.listen(PORT, () => console.log(`🚀 نظام قطرة وشرارة مستقر`));